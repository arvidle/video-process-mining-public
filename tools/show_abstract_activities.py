...
from video_pm.visualization.activity_recognition import ActionDetectionVideo, AbstractedActivitiesVideo
...
abstractor = BaselineAbstractor(10)
abstract_detections = abstractor.process_action_log(detections2)

#dv1 = DetectionVideo(detections1, video)
dv2 = AbstractedActivitiesVideo(abstract_detections, video)

fps = 1
width = 854 # * 2
height = 480
output_size = (width, height)
out = cv2.VideoWriter("abstract_activities.mp4", cv2.VideoWriter_fourcc('m', 'p', '4', 'v'), fps, output_size)
