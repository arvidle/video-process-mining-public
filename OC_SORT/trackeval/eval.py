...
class Evaluator:
    ...
    def get_default_eval_config():
        ...
        default_config = {
            ...
            'OUTPUT_SUMMARY': True,
            'OUTPUT_EMPTY_CLASSES': True,  # If False, summary files are not visualization for classes with no detections
        ...
        for dataset, dataset_name in zip(dataset_list, dataset_names):
            ...
            for tracker in tracker_list:
                ...
                try:
                    ...
                    # Print and visualization results in various formats
