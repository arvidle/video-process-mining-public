...
class KalmanFilterNew(object):
    ...
    **Example**
    ...
    def batch_filter(self, zs, Fs=None, Qs=None, Hs=None,
       ...
       update_first : bool, optional, default=False
        ...
        .. code-block:: Python
            ...
            # that F be recomputed for each epoch. The visualization is then smoothed
    ...
    def rts_smoother(self, Xs, Ps, Fs=None, Qs=None, inv=np.linalg.inv):
        ...
        would come from the visualization of `KalmanFilter.batch_filter()`.
        Parameters
        ----------
        Xs : numpy.array
           array of the means (state variable x) of the visualization of a Kalman
           filter.
        Ps : numpy.array
            array of the covariances of the visualization of a kalman filter.
